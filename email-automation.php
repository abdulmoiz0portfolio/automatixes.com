    ...
    <div class="container position-relative" style="z-index: 1;">
        ...
        <div class="text-center max-w-850 mx-auto mb-5">
            <div class="d-inline-flex align-items-center gap-2 px-3 py-1.5 rounded-pill mb-4" style="background: rgba(200, 224, 25, 0.08); border: 1px solid rgba(200, 224, 25, 0.25); box-shadow: 0 0 25px rgba(200, 224, 25, 0.12);">
                <span class="badge rounded-pill px-2 py-0.5" style="background: #C8E019; color: #000; font-size: 0.7rem; font-weight: 800; letter-spacing: 0.05em;"><i class="fa-solid fa-envelope-open-text me-1"></i> SERVICE</span>
                <span class="text-white small fw-bold" style="font-size: 0.85rem;">OUTBOUND & INBOUND EMAIL SYSTEMS</span>
            </div>
            
            <h1 class="display-4 fw-extrabold text-white mb-3" style="letter-spacing: -0.03em; line-height: 1.15;">
                Automated Email Engines & Deliverability Pipelines
            </h1>
            
            <p class="lead text-white-50 mx-auto" style="max-width: 740px; font-size: 1.15rem; line-height: 1.7;">
                Stop losing replies in chaotic inboxes. We design multi-mailbox outreach workflows with DNS/MX verification, AI reply classification, and automated warm routing directly into your sales calendar.
            </p>
        ...
        <div class="row g-3 mb-5">
            ...
            <div class="col-6 col-md-3">
                <div class="p-4 rounded-4 h-100 text-center" style="background: rgba(255, 255, 255, 0.02); border: 1px solid rgba(255, 255, 255, 0.06); backdrop-filter: blur(8px);">
                    ...
                    <div class="text-white small fw-bold mb-1">Hard Bounce Target</div>
                    <div class="text-white-50" style="font-size: 0.75rem;">DNS MX record pre-flight check</div>
                </div>
            </div>
            <div class="col-6 col-md-3">
                <div class="p-4 rounded-4 h-100 text-center" style="background: rgba(255, 255, 255, 0.02); border: 1px solid rgba(255, 255, 255, 0.06); backdrop-filter: blur(8px);">
                    <div class="display-6 fw-extrabold text-accent-brand font-monospace mb-1">< 60s</div>
                    <div class="text-white small fw-bold mb-1">Speed-to-Reply</div>
                    <div class="text-white-50" style="font-size: 0.75rem;">Instant AI triage of inbound emails</div>
                </div>
            </div>
            <div class="col-6 col-md-3">
                <div class="p-4 rounded-4 h-100 text-center" style="background: rgba(255, 255, 255, 0.02); border: 1px solid rgba(255, 255, 255, 0.06); backdrop-filter: blur(8px);">
                    <div class="display-6 fw-extrabold text-accent-brand font-monospace mb-1">100%</div>
                    <div class="text-white small fw-bold mb-1">Inbox Placement</div>
                    <div class="text-white-50" style="font-size: 0.75rem;">SPF, DKIM, DMARC compliant setup</div>
                </div>
            </div>
            <div class="col-6 col-md-3">
                <div class="p-4 rounded-4 h-100 text-center" style="background: rgba(255, 255, 255, 0.02); border: 1px solid rgba(255, 255, 255, 0.06); backdrop-filter: blur(8px);">
                    <div class="display-6 fw-extrabold text-accent-brand font-monospace mb-1">+28%</div>
                    <div class="text-white small fw-bold mb-1">Meeting Booking Rate</div>
                    <div class="text-white-50" style="font-size: 0.75rem;">Through conversational multi-touch follow-ups</div>
                </div>
            </div>
        </div>
        ...
        <div class="row g-4 mb-5">
            ...
            <div class="col-lg-6">
                <div class="p-4 p-md-5 rounded-4 h-100" style="background: rgba(239, 68, 68, 0.03); border: 1px solid rgba(239, 68, 68, 0.2); box-shadow: 0 10px 30px rgba(0,0,0,0.25);">
                    <div class="d-flex align-items-center gap-2 mb-3 pb-2 border-bottom border-danger border-opacity-25">
                        ...
                        <h4 class="h5 fw-bold text-white mb-0">Email Fatigue & Pipeline Leaks</h4>
                    </div>
            ...
            <li class="d-flex align-items-start gap-3">
                ...
                <span class="text-white-50 small" style="line-height: 1.6;">Cold emails bounce due to unverified leads, ruining your domain reputation and landing messages in spam.</span>
            </li>
            <li class="d-flex align-items-start gap-3">
                <div class="rounded-circle d-flex align-items-center justify-content-center flex-shrink-0 mt-1" style="background: rgba(239, 68, 68, 0.15); color: #f87171; border: 1px solid rgba(239, 68, 68, 0.3); width: 26px; height: 26px; font-size: 11px;">
                    <i class="fa-solid fa-xmark"></i>
                </div>
                <span class="text-white-50 small" style="line-height: 1.6;">Hot prospect replies get buried beneath newsletters and internal threads, going cold before sales notices.</span>
            </li>
            <li class="d-flex align-items-start gap-3">
                <div class="rounded-circle d-flex align-items-center justify-content-center flex-shrink-0 mt-1" style="background: rgba(239, 68, 68, 0.15); color: #f87171; border: 1px solid rgba(239, 68, 68, 0.3); width: 26px; height: 26px; font-size: 11px;">
                    <i class="fa-solid fa-xmark"></i>
                </div>
                <span class="text-white-50 small" style="line-height: 1.6;">Manual follow-ups stop after 1 or 2 attempts because reps lack time to track multi-stage sequences.</span>
            </li>
                    </ul>
                </div>
            </div>
            ...
            <div class="col-lg-6">
                <div class="p-4 p-md-5 rounded-4 h-100" style="background: rgba(200, 224, 25, 0.03); border: 1px solid rgba(200, 224, 25, 0.25); box-shadow: 0 10px 30px rgba(0,0,0,0.25);">
                    <div class="d-flex align-items-center gap-2 mb-3 pb-2 border-bottom border-warning border-opacity-25">
                        ...
                        <h4 class="h5 fw-bold text-white mb-0">The Autonomous Email Engine</h4>
                    </div>
                    <ul class="list-unstyled d-flex flex-column gap-3 mb-0">
            ...
            <li class="d-flex align-items-start gap-3">
                ...
                <span class="text-white-50 small" style="line-height: 1.6;">Every lead email is automatically validated via DNS MX checks before any message is dispatched.</span>
            </li>
            <li class="d-flex align-items-start gap-3">
                <div class="rounded-circle d-flex align-items-center justify-content-center flex-shrink-0 mt-1" style="background: rgba(200, 224, 25, 0.15); color: #C8E019; border: 1px solid rgba(200, 224, 25, 0.3); width: 26px; height: 26px; font-size: 11px;">
                    <i class="fa-solid fa-check"></i>
                </div>
                <span class="text-white-50 small" style="line-height: 1.6;">AI sentiment analyzers parse incoming replies in real-time, tagging them as "Interested", "Objection", or "Unsubscribe".</span>
            </li>
            <li class="d-flex align-items-start gap-3">
                <div class="rounded-circle d-flex align-items-center justify-content-center flex-shrink-0 mt-1" style="background: rgba(200, 224, 25, 0.15); color: #C8E019; border: 1px solid rgba(200, 224, 25, 0.3); width: 26px; height: 26px; font-size: 11px;">
                    <i class="fa-solid fa-check"></i>
                </div>
                <span class="text-white-50 small" style="line-height: 1.6;">Interested replies immediately trigger calendar scheduling links and notify the designated account executive.</span>
            </li>
                    </ul>
                </div>
            </div>
        ...
        <div class="mb-5 pb-3">
            ...
            <div class="col-md-6">
                <div class="p-4 rounded-4 h-100 service-feature-card" style="background: rgba(255, 255, 255, 0.03); border: 1px solid rgba(255, 255, 255, 0.08); transition: transform 0.3s ease, border-color 0.3s ease;">
                    ...
                    <h4 class="h5 fw-bold text-white mb-2">Zero-Bounce DNS/MX Safeguard</h4>
                    <p class="text-white-50 small mb-0" style="line-height: 1.6;">Pre-send domain validation prevents sending to invalid or dead mailboxes, safeguarding sender score.</p>
                </div>
            </div>
            <div class="col-md-6">
                <div class="p-4 rounded-4 h-100 service-feature-card" style="background: rgba(255, 255, 255, 0.03); border: 1px solid rgba(255, 255, 255, 0.08); transition: transform 0.3s ease, border-color 0.3s ease;">
                    ...
                    <h4 class="h5 fw-bold text-white mb-2">AI Reply Intent Classification</h4>
                    <p class="text-white-50 small mb-0" style="line-height: 1.6;">GPT-4o categorizes incoming emails by sentiment and prepares smart contextual draft responses in seconds.</p>
                </div>
            </div>
            <div class="col-md-6">
                <div class="p-4 rounded-4 h-100 service-feature-card" style="background: rgba(255, 255, 255, 0.03); border: 1px solid rgba(255, 255, 255, 0.08); transition: transform 0.3s ease, border-color 0.3s ease;">
                    ...
                    <h4 class="h5 fw-bold text-white mb-2">Distributed Multi-Mailbox Rotation</h4>
                    <p class="text-white-50 small mb-0" style="line-height: 1.6;">Distribute outbound volume across authenticated domains to maintain strict volume hygiene.</p>
                </div>
            </div>
            <div class="col-md-6">
                <div class="p-4 rounded-4 h-100 service-feature-card" style="background: rgba(255, 255, 255, 0.03); border: 1px solid rgba(255, 255, 255, 0.08); transition: transform 0.3s ease, border-color 0.3s ease;">
                    ...
                    <h4 class="h5 fw-bold text-white mb-2">Automated 1-Click Scheduling</h4>
                    <p class="text-white-50 small mb-0" style="line-height: 1.6;">Turn positive replies into confirmed calendar appointments without the tedious "what time works" dance.</p>
                </div>
            </div>
            </div>
        </div>
        ...
        <div class="p-4 rounded-4 text-center mb-5" style="background: rgba(255, 255, 255, 0.02); border: 1px solid rgba(255, 255, 255, 0.06);">
            ...
            <div class="d-flex flex-wrap justify-content-center gap-2">
                <span class="badge rounded-pill px-3 py-1.5 small text-white" style="background: rgba(255,255,255,0.05); border: 1px solid rgba(255,255,255,0.1); font-size: 0.8rem;"><i class="fa-solid fa-code-commit text-accent-neon me-1"></i> n8n</span> <span class="badge rounded-pill px-3 py-1.5 small text-white" style="background: rgba(255,255,255,0.05); border: 1px solid rgba(255,255,255,0.1); font-size: 0.8rem;"><i class="fa-solid fa-code-commit text-accent-neon me-1"></i> OpenAI</span> <span class="badge rounded-pill px-3 py-1.5 small text-white" style="background: rgba(255,255,255,0.05); border: 1px solid rgba(255,255,255,0.1); font-size: 0.8rem;"><i class="fa-solid fa-code-commit text-accent-neon me-1"></i> Google Workspace API</span> <span class="badge rounded-pill px-3 py-1.5 small text-white" style="background: rgba(255,255,255,0.05); border: 1px solid rgba(255,255,255,0.1); font-size: 0.8rem;"><i class="fa-solid fa-code-commit text-accent-neon me-1"></i> Zoho Mail</span> <span class="badge rounded-pill px-3 py-1.5 small text-white" style="background: rgba(255,255,255,0.05); border: 1px solid rgba(255,255,255,0.1); font-size: 0.8rem;"><i class="fa-solid fa-code-commit text-accent-neon me-1"></i> Cloudflare DNS</span> <span class="badge rounded-pill px-3 py-1.5 small text-white" style="background: rgba(255,255,255,0.05); border: 1px solid rgba(255,255,255,0.1); font-size: 0.8rem;"><i class="fa-solid fa-code-commit text-accent-neon me-1"></i> Smartlead</span>
            </div>
        </div>
            ...
            <div class="col-lg-8">
                <div class="p-4 p-md-5 rounded-4 text-center position-relative overflow-hidden" style="background: linear-gradient(145deg, #0b1120 0%, #0d1527 100%); border: 2px solid rgba(200, 224, 25, 0.35); box-shadow: 0 15px 40px rgba(0,0,0,0.5);">
                    ...
                    <p class="text-white-50 small mb-4 mx-auto" style="max-width: 540px; line-height: 1.6;">
                        Includes domain health configuration, DNS MX automation nodes, reply classification AI, and CRM linking.
                    </p>
                    <div class="d-flex flex-wrap justify-content-center gap-3">
                        ...
                        <a href="https://wa.me/923366920141?text=Hi%20Automatixes%2C%20I%27m%20interested%20in%20your%20email-automation%20service." target="_blank" class="btn btn-outline-light rounded-pill px-4 py-3 fw-semibold">
        ...
        <div id="consultation" class="pt-4">
            <div class="max-w-700 mx-auto p-4 p-md-5 rounded-4" style="background: rgba(255, 255, 255, 0.02); border: 1px solid rgba(255, 255, 255, 0.08);">
                ...
                <form action="contact" method="GET" class="row g-3">
                    <input type="hidden" name="service" value="Automated Email Engines & Deliverability Pipelines">
                    <div class="col-md-6">
