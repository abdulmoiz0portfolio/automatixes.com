            ...
            <div class="row mb-4">
                <div class="col-lg-8 mx-auto text-center">
                    <div class="p-4 rounded-4" style="background: rgba(255,255,255,0.04); border: 1px solid rgba(255,255,255,0.08);">
                        <h5 class="mb-2" style="font-weight: 700; font-size: 18px;">📬 Stay Ahead with AI Automation Insights</h5>
                        <p class="text-muted mb-3" style="font-size: 14px;">Join 500+ founders & operators getting weekly AI automation strategies, case studies, and free workflow templates.</p>
                        <form id="footer-newsletter-form" class="d-flex flex-column flex-sm-row gap-2 justify-content-center" style="max-width: 480px; margin: 0 auto;" novalidate>
                            <input type="email" id="footer-newsletter-email" placeholder="Enter your email" required
                                style="flex: 1; padding: 12px 16px; border-radius: 10px; border: 1px solid rgba(255,255,255,0.12); background: rgba(255,255,255,0.06); color: #fff; font-size: 14px; outline: none; transition: border-color 0.2s ease;"
                                onfocus="this.style.borderColor='rgba(99,102,241,0.6)'" onblur="this.style.borderColor='rgba(255,255,255,0.12)'">
                            <button type="submit" class="btn btn-brand px-4 py-2 d-flex align-items-center gap-2" style="border-radius: 10px; font-weight: 600; font-size: 14px; white-space: nowrap;">
                                <span>Subscribe</span>
                                <i class="fa-solid fa-paper-plane"></i>
                            </button>
                        </form>
                        <p class="text-muted mt-2 mb-0" style="font-size: 11px;">No spam. Unsubscribe anytime. We respect your inbox.</p>
                    </div>
                </div>
            </div>
    ...
    <div id="cookie-consent-banner" style="display:none; position:fixed; bottom:0; left:0; right:0; z-index:2147483646; background:rgba(11,15,25,0.97); backdrop-filter:blur(16px); -webkit-backdrop-filter:blur(16px); border-top:1px solid rgba(255,255,255,0.1); padding:18px 24px; font-family:'Plus Jakarta Sans',-apple-system,BlinkMacSystemFont,sans-serif;">
      <div style="max-width:1200px; margin:0 auto; display:flex; align-items:center; justify-content:space-between; flex-wrap:wrap; gap:14px;">
        <div style="flex:1; min-width:280px; color:#94a3b8; font-size:13px; line-height:1.5;">
          <strong style="color:#fff;">🍪 We value your privacy.</strong>
          We use cookies and Google Analytics to understand how you use our site and improve your experience. You can accept or decline non-essential cookies.
          <a href="privacy" style="color:#C8E019; text-decoration:underline; margin-left:4px;">Privacy Policy</a>
        </div>
        <div style="display:flex; gap:10px; flex-shrink:0;">
          <button id="cookie-reject-btn" style="padding:8px 20px; border-radius:8px; border:1px solid rgba(255,255,255,0.15); background:transparent; color:#94a3b8; font-size:13px; font-weight:600; cursor:pointer; transition:all 0.2s;">Decline</button>
          <button id="cookie-accept-btn" style="padding:8px 24px; border-radius:8px; border:none; background:#C8E019; color:#0b0f19; font-size:13px; font-weight:700; cursor:pointer; transition:all 0.2s;">Accept All</button>
        </div>
      </div>
    </div>
    <script>
    ...
    <!-- Cookie Consent Banner -->
    <div id="cookieConsentBanner" style="display:none;position:fixed;bottom:0;left:0;right:0;z-index:2147483646;background:rgba(15,23,42,0.97);backdrop-filter:blur(16px);-webkit-backdrop-filter:blur(16px);border-top:1px solid rgba(255,255,255,0.1);padding:18px 24px;font-family:'Plus Jakarta Sans',system-ui,sans-serif;">
      <div style="max-width:1200px;margin:0 auto;display:flex;align-items:center;justify-content:space-between;gap:20px;flex-wrap:wrap;">
        <p style="margin:0;color:#94a3b8;font-size:14px;line-height:1.6;flex:1;min-width:280px;">
          We use cookies and Google Analytics to understand how you use our site and improve your experience. By clicking <strong style="color:#fff;">"Accept All"</strong>, you consent to analytics and personalization cookies.
          <a href="privacy" style="color:#C8E019;text-decoration:underline;margin-left:4px;">Privacy Policy</a>
        </p>
        <div style="display:flex;gap:10px;flex-shrink:0;">
          <button onclick="handleCookieConsent('denied')" style="padding:10px 22px;border-radius:8px;border:1px solid rgba(255,255,255,0.15);background:transparent;color:#94a3b8;font-size:13px;font-weight:600;cursor:pointer;transition:all .2s;">Reject All</button>
          <button onclick="handleCookieConsent('granted')" style="padding:10px 22px;border-radius:8px;border:none;background:#C8E019;color:#0b0f19;font-size:13px;font-weight:700;cursor:pointer;transition:all .2s;">Accept All</button>
        </div>
      </div>
    </div>
    <script>
