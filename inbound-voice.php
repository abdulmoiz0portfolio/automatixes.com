    ...
    <div class="container position-relative" style="z-index: 1;">
        ...
        <div class="text-center max-w-850 mx-auto mb-5">
            <div class="d-inline-flex align-items-center gap-2 px-3 py-1.5 rounded-pill mb-4" style="background: rgba(200, 224, 25, 0.08); border: 1px solid rgba(200, 224, 25, 0.25); box-shadow: 0 0 25px rgba(200, 224, 25, 0.12);">
                <span class="badge rounded-pill px-2 py-0.5" style="background: #C8E019; color: #000; font-size: 0.7rem; font-weight: 800; letter-spacing: 0.05em;"><i class="fa-solid fa-phone-volume me-1"></i> SERVICE</span>
                <span class="text-white small fw-bold" style="font-size: 0.85rem;">CONVERSATIONAL VOICE AI</span>
            </div>
            
            <h1 class="display-4 fw-extrabold text-white mb-3" style="letter-spacing: -0.03em; line-height: 1.15;">
                Autonomous Inbound AI Voice Receptionist & Booking Bot
            </h1>
            
            <p class="lead text-white-50 mx-auto" style="max-width: 740px; font-size: 1.15rem; line-height: 1.7;">
                Never let an inbound phone call go to voicemail again. Our conversational AI voice agents answer in under 500ms, understand natural accents, handle objections, and book meetings directly into your calendar.
            </p>
        ...
        <div class="row g-3 mb-5">
            ...
            <div class="col-6 col-md-3">
                <div class="p-4 rounded-4 h-100 text-center" style="background: rgba(255, 255, 255, 0.02); border: 1px solid rgba(255, 255, 255, 0.06); backdrop-filter: blur(8px);">
                    <div class="display-6 fw-extrabold text-accent-brand font-monospace mb-1">< 500ms</div>
                    <div class="text-white small fw-bold mb-1">Cadence Latency</div>
                    <div class="text-white-50" style="font-size: 0.75rem;">Human-like conversational speed</div>
                </div>
            </div>
            <div class="col-6 col-md-3">
                <div class="p-4 rounded-4 h-100 text-center" style="background: rgba(255, 255, 255, 0.02); border: 1px solid rgba(255, 255, 255, 0.06); backdrop-filter: blur(8px);">
                    <div class="display-6 fw-extrabold text-accent-brand font-monospace mb-1">0</div>
                    <div class="text-white small fw-bold mb-1">Missed Inbound Calls</div>
                    <div class="text-white-50" style="font-size: 0.75rem;">Handles 100 concurrent calls simultaneously</div>
                </div>
            </div>
            <div class="col-6 col-md-3">
                <div class="p-4 rounded-4 h-100 text-center" style="background: rgba(255, 255, 255, 0.02); border: 1px solid rgba(255, 255, 255, 0.06); backdrop-filter: blur(8px);">
                    <div class="display-6 fw-extrabold text-accent-brand font-monospace mb-1">92%</div>
                    <div class="text-white small fw-bold mb-1">Booking Completion</div>
                    <div class="text-white-50" style="font-size: 0.75rem;">For qualified incoming prospect inquiries</div>
                </div>
            </div>
            <div class="col-6 col-md-3">
                <div class="p-4 rounded-4 h-100 text-center" style="background: rgba(255, 255, 255, 0.02); border: 1px solid rgba(255, 255, 255, 0.06); backdrop-filter: blur(8px);">
                    <div class="display-6 fw-extrabold text-accent-brand font-monospace mb-1">24/7</div>
                    <div class="text-white small fw-bold mb-1">After-Hours Availability</div>
                    <div class="text-white-50" style="font-size: 0.75rem;">Captures evening & weekend buyers</div>
                </div>
            </div>
        </div>
        ...
        <div class="row g-4 mb-5">
            ...
            <div class="col-lg-6">
                <div class="p-4 p-md-5 rounded-4 h-100" style="background: rgba(239, 68, 68, 0.03); border: 1px solid rgba(239, 68, 68, 0.2); box-shadow: 0 10px 30px rgba(0,0,0,0.25);">
                    <div class="d-flex align-items-center gap-2 mb-3 pb-2 border-bottom border-danger border-opacity-25">
                        ...
                        <h4 class="h5 fw-bold text-white mb-0">The Cost of Missed Phone Calls</h4>
                    </div>
            ...
            <li class="d-flex align-items-start gap-3">
                ...
                <span class="text-white-50 small" style="line-height: 1.6;">62% of customers who reach a voicemail hang up and call the next competitor on Google.</span>
            </li>
            <li class="d-flex align-items-start gap-3">
                <div class="rounded-circle d-flex align-items-center justify-content-center flex-shrink-0 mt-1" style="background: rgba(239, 68, 68, 0.15); color: #f87171; border: 1px solid rgba(239, 68, 68, 0.3); width: 26px; height: 26px; font-size: 11px;">
                    <i class="fa-solid fa-xmark"></i>
                </div>
                <span class="text-white-50 small" style="line-height: 1.6;">Hiring full-time front-desk receptionists costs $3,500+/mo per shift and still leaves weekends uncovered.</span>
            </li>
            <li class="d-flex align-items-start gap-3">
                <div class="rounded-circle d-flex align-items-center justify-content-center flex-shrink-0 mt-1" style="background: rgba(239, 68, 68, 0.15); color: #f87171; border: 1px solid rgba(239, 68, 68, 0.3); width: 26px; height: 26px; font-size: 11px;">
                    <i class="fa-solid fa-xmark"></i>
                </div>
                <span class="text-white-50 small" style="line-height: 1.6;">Traditional phone trees ("Press 1 for Sales") frustrate callers and increase abandonment rates.</span>
            </li>
                    </ul>
                </div>
            </div>
            ...
            <div class="col-lg-6">
                <div class="p-4 p-md-5 rounded-4 h-100" style="background: rgba(200, 224, 25, 0.03); border: 1px solid rgba(200, 224, 25, 0.25); box-shadow: 0 10px 30px rgba(0,0,0,0.25);">
                    <div class="d-flex align-items-center gap-2 mb-3 pb-2 border-bottom border-warning border-opacity-25">
                        ...
                        <h4 class="h5 fw-bold text-white mb-0">The Real-Time Voice Receptionist</h4>
                    </div>
                    <ul class="list-unstyled d-flex flex-column gap-3 mb-0">
            ...
            <li class="d-flex align-items-start gap-3">
                ...
                <span class="text-white-50 small" style="line-height: 1.6;">Answers immediately on ring one with natural, warm human cadence and conversational tone.</span>
            </li>
            <li class="d-flex align-items-start gap-3">
                <div class="rounded-circle d-flex align-items-center justify-content-center flex-shrink-0 mt-1" style="background: rgba(200, 224, 25, 0.15); color: #C8E019; border: 1px solid rgba(200, 224, 25, 0.3); width: 26px; height: 26px; font-size: 11px;">
                    <i class="fa-solid fa-check"></i>
                </div>
                <span class="text-white-50 small" style="line-height: 1.6;">Listens intelligently, handles interruptions gracefully, and checks real-time calendar availability.</span>
            </li>
            <li class="d-flex align-items-start gap-3">
                <div class="rounded-circle d-flex align-items-center justify-content-center flex-shrink-0 mt-1" style="background: rgba(200, 224, 25, 0.15); color: #C8E019; border: 1px solid rgba(200, 224, 25, 0.3); width: 26px; height: 26px; font-size: 11px;">
                    <i class="fa-solid fa-check"></i>
                </div>
                <span class="text-white-50 small" style="line-height: 1.6;">Directly writes caller notes, audio recording links, and transcripts into your CRM after every conversation.</span>
            </li>
                    </ul>
                </div>
            </div>
        ...
        <div class="mb-5 pb-3">
            ...
            <div class="col-md-6">
                <div class="p-4 rounded-4 h-100 service-feature-card" style="background: rgba(255, 255, 255, 0.03); border: 1px solid rgba(255, 255, 255, 0.08); transition: transform 0.3s ease, border-color 0.3s ease;">
                    ...
                    <h4 class="h5 fw-bold text-white mb-2">Sub-500ms Natural Response</h4>
                    <p class="text-white-50 small mb-0" style="line-height: 1.6;">Powered by cutting-edge low-latency voice engines (Retell, Vapi, Cartesia) for fluid dialogue.</p>
                </div>
            </div>
            <div class="col-md-6">
                <div class="p-4 rounded-4 h-100 service-feature-card" style="background: rgba(255, 255, 255, 0.03); border: 1px solid rgba(255, 255, 255, 0.08); transition: transform 0.3s ease, border-color 0.3s ease;">
                    ...
                    <h4 class="h5 fw-bold text-white mb-2">Live Calendar Slot Booking</h4>
                    <p class="text-white-50 small mb-0" style="line-height: 1.6;">Coordinates mutually available times with callers and confirms appointments via immediate SMS.</p>
                </div>
            </div>
            <div class="col-md-6">
                <div class="p-4 rounded-4 h-100 service-feature-card" style="background: rgba(255, 255, 255, 0.03); border: 1px solid rgba(255, 255, 255, 0.08); transition: transform 0.3s ease, border-color 0.3s ease;">
                    ...
                    <h4 class="h5 fw-bold text-white mb-2">Live Call Transfer Option</h4>
                    <p class="text-white-50 small mb-0" style="line-height: 1.6;">Can warm-transfer VIP or emergency callers to a human specialist on their personal phone.</p>
                </div>
            </div>
            <div class="col-md-6">
                <div class="p-4 rounded-4 h-100 service-feature-card" style="background: rgba(255, 255, 255, 0.03); border: 1px solid rgba(255, 255, 255, 0.08); transition: transform 0.3s ease, border-color 0.3s ease;">
                    ...
                    <h4 class="h5 fw-bold text-white mb-2">Full Audio & Transcript Logs</h4>
                    <p class="text-white-50 small mb-0" style="line-height: 1.6;">Automated call summary, full text transcript, and caller sentiment sent to your CRM and Slack.</p>
                </div>
            </div>
            </div>
        </div>
        ...
        <div class="p-4 rounded-4 text-center mb-5" style="background: rgba(255, 255, 255, 0.02); border: 1px solid rgba(255, 255, 255, 0.06);">
            ...
            <div class="d-flex flex-wrap justify-content-center gap-2">
                <span class="badge rounded-pill px-3 py-1.5 small text-white" style="background: rgba(255,255,255,0.05); border: 1px solid rgba(255,255,255,0.1); font-size: 0.8rem;"><i class="fa-solid fa-code-commit text-accent-neon me-1"></i> Retell AI / Vapi</span> <span class="badge rounded-pill px-3 py-1.5 small text-white" style="background: rgba(255,255,255,0.05); border: 1px solid rgba(255,255,255,0.1); font-size: 0.8rem;"><i class="fa-solid fa-code-commit text-accent-neon me-1"></i> Cartesia Voice</span> <span class="badge rounded-pill px-3 py-1.5 small text-white" style="background: rgba(255,255,255,0.05); border: 1px solid rgba(255,255,255,0.1); font-size: 0.8rem;"><i class="fa-solid fa-code-commit text-accent-neon me-1"></i> Twilio Telephony</span> <span class="badge rounded-pill px-3 py-1.5 small text-white" style="background: rgba(255,255,255,0.05); border: 1px solid rgba(255,255,255,0.1); font-size: 0.8rem;"><i class="fa-solid fa-code-commit text-accent-neon me-1"></i> n8n</span> <span class="badge rounded-pill px-3 py-1.5 small text-white" style="background: rgba(255,255,255,0.05); border: 1px solid rgba(255,255,255,0.1); font-size: 0.8rem;"><i class="fa-solid fa-code-commit text-accent-neon me-1"></i> Google Calendar</span> <span class="badge rounded-pill px-3 py-1.5 small text-white" style="background: rgba(255,255,255,0.05); border: 1px solid rgba(255,255,255,0.1); font-size: 0.8rem;"><i class="fa-solid fa-code-commit text-accent-neon me-1"></i> HubSpot</span>
            </div>
        </div>
            ...
            <div class="col-lg-8">
                <div class="p-4 p-md-5 rounded-4 text-center position-relative overflow-hidden" style="background: linear-gradient(145deg, #0b1120 0%, #0d1527 100%); border: 2px solid rgba(200, 224, 25, 0.35); box-shadow: 0 15px 40px rgba(0,0,0,0.5);">
                    ...
                    <p class="text-white-50 small mb-4 mx-auto" style="max-width: 540px; line-height: 1.6;">
                        Includes voice persona design, prompt testing, phone number provisioning, calendar sync, and usage config.
                    </p>
                    <div class="d-flex flex-wrap justify-content-center gap-3">
                        ...
                        <a href="https://wa.me/923366920141?text=Hi%20Automatixes%2C%20I%27m%20interested%20in%20your%20inbound-voice%20service." target="_blank" class="btn btn-outline-light rounded-pill px-4 py-3 fw-semibold">
        ...
        <div id="consultation" class="pt-4">
            <div class="max-w-700 mx-auto p-4 p-md-5 rounded-4" style="background: rgba(255, 255, 255, 0.02); border: 1px solid rgba(255, 255, 255, 0.08);">
                ...
                <form action="contact" method="GET" class="row g-3">
                    <input type="hidden" name="service" value="Autonomous Inbound AI Voice Receptionist & Booking Bot">
                    <div class="col-md-6">
