...
<section id="services-section" class="section-padding bg-surface text-white">
    <div class="container">
        <div class="text-center mb-5 max-w-700 mx-auto">
            ...
            <p class="text-white-50 fs-5">We combine strategy, design, and automation to scale your business.</p>
        </div>
                    ...
                    <div class="row g-0 align-items-center">
                        ...
                        <div class="col-md-6">
                            <div class="content p-4 p-lg-5">
                                ...
                                <h3><a href="ai-automated-solutions" class="text-white text-decoration-none">AI Automated Solutions</a></h3>
                                <p class="text-white-50 mb-2">Smart digital agents that automate customer support, qualify leads, and execute tasks 24/7 — combined with rule-based workflows that sync your CRM, pipelines, and communication tools seamlessly.</p>
                                <ul class="list-unstyled text-white-50 small mb-3" style="line-height: 2;">
        ...
        <div class="row g-4 justify-content-center">
            ...
            <div class="col-lg-5 col-md-6">
                <div class="card-service-item wow fadeInUp" data-wow-delay=".8s">
                    ...
                    <div class="content">
                        <h3><a href="product-shoot" class="text-white text-decoration-none">Product Shoot</a></h3>
                        <p class="text-white-50">High-end commercial product photography featuring studio lighting and custom setups to showcase your products.</p>
...
<section id="faq-section" class="section-padding bg-transparent text-white border-top border-light-subtle">
    <div class="container max-w-800">
        <div class="text-center mb-5">
            ...
            <p class="text-white-50 fs-5">Common queries answered about our development and AI processes.</p>
        </div>
